...
export function MessagesDebugControls(props) {
  ...
  return (
    <div
      className={clsx(
        `${className || ''} pointer-events-auto flex overflow-hidden rounded-l-3xl rounded-r-none border border-r-0 shadow-2xl backdrop-blur transition-all duration-200 ease-out`,
        expanded
          ...
          : 'h-10 min-w-[3rem] flex-nowrap items-center justify-end gap-0 px-0 py-0'
      )}
      style={floatingStyle}
