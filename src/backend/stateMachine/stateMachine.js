...
export class StateMachine {
    ...
    exportAsMessageList(params = {}) {
        return this.recordHistory.exportAsMessageList(this.versionInfo, params);
    }

    convertToMessageList(records, params = {}) {
        return this.recordHistory.exportAsMessageList_static(this.versionInfo, records, params);
    }
}